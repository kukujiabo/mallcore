    ...
    if (!$data['excel']) {
      ...
      foreach($members as $member) {
        ...
        $memberData = array(
          ...
          'member_name' => $member['member_name'], //iconv('GBK//IGNORE', 'UTF-8', $member['member_name']),
          'user_tel' => $member['user_tel'],
          'recommend_user' => $member['recommend_user'], // iconv('GBK//IGNORE', 'UTF-8', $member['recommend_user']),
